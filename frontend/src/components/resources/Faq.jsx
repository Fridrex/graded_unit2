            ...
            <ul className="resources__info-blocks__faq__main">
              ...
              <li>
                ...
                <p>
                  ...
                  and update it to reflect the latest developments in blockchain technology, cryptocurrencies, and CBDCs
                </p>
              </li>
              <li>
                <p className="resources__info-blocks__faq__main__question">
              ...
              <li>
                ...
                <p>A: No, it is a simulation tool for educational purposes only. No real cryptocurrency is involved.</p>
              </li>
              <li>
                <p className="resources__info-blocks__faq__main__question">
