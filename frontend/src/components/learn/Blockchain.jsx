    ...
    <>
      <div className="learn__blockchain">
        ...
        <p>
          ...
          many cryptocurrencies, but its applications go far beyond that, impacting various industries from supply chain
          management to voting systems.
        </p>
        <p>
          This section will break down these concepts further, using visuals and simple language, so you can confidently
          grasp how blockchain works and its potential.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Wallet:</strong> A digital wallet is where you store your digital currencies. It's similar to a bank
            account, but instead of holding traditional money, it holds the digital codes that allow you to access your
            cryptocurrency.
          </li>
          <li>
          ...
          <li>
            <strong>Decentralisation:</strong> This means that no single entity, like a bank or government, controls the
            digital currency. The network is typically run by its users.
          </li>
        </ul>
        <p>
        ...
        <ul>
          <li>
            ...
            can view the transactions and participate in the network. Bitcoin and Ethereum are prime examples of public
            blockchains.
          </li>
          <li>
            <strong>Private Blockchain:</strong> Imagine a record book that's only accessible to specific people within
            an organisation. Private blockchains are permissioned, meaning you need authorisation to join and
            participate. They are often used by businesses for internal purposes.
          </li>
          <li>
            <strong>Federated/Consortium Blockchain:</strong> This is like a mix of public and private. Instead of being
            controlled by a single organisation, it's governed by a group or consortium of organisations. This offers a
            balance between transparency and control.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            alter records), public blockchains are generally considered completely tamper-proof due to their widespread
            distribution. Private and consortium blockchains might be less so, depending on their specific setup.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Proof-of-Work (PoW):</strong> This is the original consensus mechanism used by Bitcoin. It involves
            network participants (miners) solving complex computational puzzles to validate transactions and create new
            blocks. This process requires significant energy.
          </li>
          <li>
            <strong>Proof-of-Stake (PoS):</strong> As an alternative to PoW, PoS selects validators based on the amount
            of cryptocurrency they "stake" or lock up. It's generally considered more energy-efficient than PoW.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>Healthcare:</strong> Securely managing and sharing medical records, improving patient care and data
            privacy.
          </li>
          <li>
        ...
        <p>Check out our Further reading page for more information</p>
      </div>
    </>
  );
};
